...
var _apolloClient = __webpack_require__(43);

var _apolloLinkHttp = __webpack_require__(44);

var _apolloCacheInmemory = __webpack_require__(45);

var _nodeFetch = __webpack_require__(46);
...
var _amount = __webpack_require__(47);

var _amount2 = _interopRequireDefault(_amount);

var _participants = __webpack_require__(48);
...
var t_3 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/travis/build/Piter-United/piter-united/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 18)), (0, _importCss3.default)('src/containers/Event', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_4 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/travis/build/Piter-United/piter-united/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 19)), (0, _importCss3.default)('src/containers/Events', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_6 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/travis/build/Piter-United/piter-united/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 21)), (0, _importCss3.default)('src/containers/Speaker', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_7 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/travis/build/Piter-United/piter-united/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 22)), (0, _importCss3.default)('src/containers/Speakers', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_8 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/travis/build/Piter-United/piter-united/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 23)), (0, _importCss3.default)('src/containers/Company', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_9 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/travis/build/Piter-United/piter-united/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 24)), (0, _importCss3.default)('src/containers/Companies', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_10 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/travis/build/Piter-United/piter-united/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 25)), (0, _importCss3.default)('src/containers/Login', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_11 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/travis/build/Piter-United/piter-united/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 26)), (0, _importCss3.default)('src/containers/404', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var Modal = function (_React$Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      return [_react2.default.createElement(
        'div',
        { key: id + '-0', style: { display: display } },
        _react2.default.createElement('div', { className: 'modal-backdrop', style: { opacity: '0.6' } }),
        _react2.default.createElement(
          'div',
          {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'button',
                  { type: 'button', className: 'close', onClick: this.toggle, 'aria-label': 'Close' },
                  _react2.default.createElement(
                    'span',
                    { 'aria-hidden': 'true' },
                    '\xD7'
              ...
              _react2.default.createElement(
                'div',
                { className: 'modal-body', style: { textAlign: 'left' } },
                _react2.default.createElement(_Text2.default, { text: body || 'Text' }),
                _react2.default.createElement(
                  'a',
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'button',
                  { type: 'button', className: 'btn btn-secondary', onClick: this.toggle },
                  '\u0417\u0430\u043A\u0440\u044B\u0442\u044C'
                )
              )
            )
        ...
        'a',
        { role: 'button', tabIndex: '-1', key: id + '-1', style: { cursor: 'pointer' }, onClick: this.toggle },
...
var PartnersList = function PartnersList(_ref) {
  var slug = _ref.slug,
      list = _ref.list,
      platinum = _ref.platinum;
  return [platinum.map(function (_ref2) {
    var id = _ref2.id,
        name = _ref2.name,
        description = _ref2.description,
        site = _ref2.site,
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(Modal, { id: id, slug: slug, title: name, site: site, url: url, body: description })
    );
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement('img', { style: styles, alt: name, src: url })
      )
    );
  })];
};
...
var Event = function (_React$Component2) {
  ...
  _createClass(Event, [{
    ...
    value: function componentWillMount() {
      ...
      _apollo2.default.query({ query: query }).then(function (_ref4) {
        var Event = _ref4.data.Event;

        _this3.setState({ event: Event });
        shareBtns(Event || _this3.props.event);
      }).catch(function (err) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(PartnersList, { slug: event.slug, platinum: event.platinumPartners, list: partners }),
          _react2.default.createElement(
            'div',
